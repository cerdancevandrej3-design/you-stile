...
## Оплаченные генерации

**Срок хранения — сутки.** Образы («Начать преображение») и «Причёска и уход» после оплаты/промо должны сохраняться на сервере и открываться в «Мои образы» / при повторном входе **24 часа**. Бесплатные черновики короче (5–6 часов). Не удалять оплаченное раньше суток и не хранить бессрочно.
