...
Exactly 5 fingers. Thumb on one side, 4 fingers on the other. Each finger has 3 natural segments connected by knuckles. When fingers bend, you see natural creases and small wrinkles at each knuckle joint. Normal finger proportions — not stretched, not swollen. If ANY finger looks plastic, waxy, mannequin-like, or has unnatural joint bending — that is a failure. Real hands have asymmetry, slight redness at knuckles, visible veins under skin.

SKIN TEXTURE — REAL NOT DOLL:
Palm facing the camera or tilted 3/4 toward the viewer. The back of the hand is visible — with fine pores, tiny light hairs, natural skin texture. NOT mannequin. NOT doll. NOT wax. NOT plastic. You can see individual pores, fine vellus hairs, subtle variations in skin tone, natural shadows where light doesn't reach between tendons. Warm healthy skin color.

POSE AND CAMERA ANGLE — VARIETY:
Fingers naturally relaxed and slightly curled — the way a real hand rests elegantly. Gentle natural curve of each finger. Thumb slightly to the side. Camera angle: macro close-up showing 1-2 nails in sharp crisp detail with soft bokeh on the rest of the hand — this is the hero shot that shows the nail design in maximum detail.
...
PROPS — SUBTLE LUXURY:
Subtle luxury props near the hand: a fresh orchid petal, a single pearl, a delicate gold ring on a finger, or a crystal. Props NEVER overpower the nails — nails remain the hero.
